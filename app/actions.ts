...
export async function checkOut() {
    ...
    if(cart && cart.items) {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: process.env.NODE_ENV === "development" ? "http://localhost:3000/payment/success" : "https://shoplux-next.vercel.app/payment/success",
            cancel_url: process.env.NODE_ENV === "development" ? "http://localhost:3000/payment/cancel" : "https://shoplux-next.vercel.app/payment/cancel",
            metadata: {
                userId: user.id,
            }
        });
